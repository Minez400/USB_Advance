...
/**
 * Detection engine for counterfeit flash drives and tampered NAND flash controllers
 * using cryptographic sector probes and sequential fill verification.
 *
...
class FakeCapacityDetector {
    ...
    /**
     * Sequential Full Fill & Verify Algorithm:
