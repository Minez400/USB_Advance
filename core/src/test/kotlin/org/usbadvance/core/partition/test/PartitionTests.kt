...
class PartitionTests {
    ...
    fun testMbrWriteAndRead() = runBlocking {
        ...
        // Verify partition starts at LBA 2048 (1 MiB alignment)
    ...
    fun testGptWrite() = runBlocking {
        ...
        // Verify LBA 1 contains "EFI PART" signature (0x5452415020494645L)
        ...
        // Verify last LBA contains Backup GPT Header
    ...
    fun testMbrOverflowClampForDisksLargerThan2Tb() = runBlocking {
        // Simulate 6 TB disk (12,884,901,888 sectors of 512B)
        ...
        // Must be strictly clamped to 0xFFFFFFFFL to prevent 32-bit MBR sector overflow
